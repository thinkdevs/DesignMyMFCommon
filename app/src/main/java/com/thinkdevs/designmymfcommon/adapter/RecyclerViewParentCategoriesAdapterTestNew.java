...
public class RecyclerViewParentCategoriesAdapterTestNew extends
        RecyclerView.Adapter<RecyclerViewParentCategoriesAdapterTestNew.CategoryViewHolder>
    ...
    public RecyclerViewParentCategoriesAdapterTestNew(Activity context, List<Category> categories) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.remove:
                        ...
                        dialogDelete = DeleteDialogFragment.newInstance(
                                RecyclerViewParentCategoriesAdapterTestNew.this,
