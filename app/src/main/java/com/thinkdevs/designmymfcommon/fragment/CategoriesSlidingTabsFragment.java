...
import com.thinkdevs.designmymfcommon.slidingtabs.view.SlidingTabLayout;

import java.util.ArrayList;
import java.util.List;

/**
 * A basic sample which shows how to use {@link com.thinkdevs.designmymfcommon.slidingtabs.view.SlidingTabLayout}
 * to display a custom {@link ViewPager} title strip which gives continuous feedback to the user
 * when scrolling.
 */
public class CategoriesSlidingTabsFragment extends Fragment {
    ...
    public static CategoriesSlidingTabsFragment newInstance(int sectionNumber) {
        Log.d("tag", "Operation Templates List Fragment - 'newInstance'");
        CategoriesSlidingTabsFragment fragment = new CategoriesSlidingTabsFragment();
    ...
    static class SamplePagerItem {
        ...
        private final Fragment categoriesList;

        SamplePagerItem(CharSequence title, int indicatorColor, int dividerColor, int type) {
            mTitle = title;
        ...
        Fragment getCategoriesList(){
            return categoriesList;
        }
    }

    static final String LOG_TAG = "CategoriesSlidingTabsFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_slidingtabs_categories, container, false);
    }
    ...
    class SampleFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int i) {
            return mTabs.get(i).getCategoriesList();
        }
