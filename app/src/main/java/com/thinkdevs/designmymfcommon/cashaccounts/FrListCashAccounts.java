...
public class FrListCashAccounts extends Fragment {
    ...
    public static FrListCashAccounts newInstance() {
        return new FrListCashAccounts();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLayoutManager = new LinearLayoutManager(FrListCashAccounts.this.getActivity());
        mRecyclerView.setLayoutManager(mLayoutManager);

        List<CashAccount> cashes = CashAccount.getCashAccounts();

        // specify an adapter (see also next example)
        mAdapter = new AdRvCashAccounts(FrListCashAccounts.this.getActivity(), cashes);
