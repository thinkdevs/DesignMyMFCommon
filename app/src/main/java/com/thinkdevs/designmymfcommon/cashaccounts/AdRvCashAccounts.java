package com.thinkdevs.designmymfcommon.cashaccounts;
...
public class AdRvCashAccounts extends
    ...
    public AdRvCashAccounts(Activity context, List<CashAccount> cashAccounts) {
    ...
    private void openEditor(long id){
        Intent intent = new Intent(mContext, AcCreateCashAccount.class);
    ...
    public class FastOperationOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if(templates != null && templates.isEmpty()){
                dialog = FrDgOperationTemplates.newInstance(
                        typeOperation, cashAccountID, AdRvCashAccounts.this);
            }
            else {
                Intent intent = new Intent(mContext, AcCreateOperation.class);
                intent.putExtra(
                        Constants.NAME,
